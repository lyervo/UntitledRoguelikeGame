 ...
 * @author Timot
 */
public class SellAllButton extends Button
{
    private TradeItem ti;
    public SellAllButton(int x, int y, int width, int height, String text, Color border, Color fill, Color hoverFill, TrueTypeFont font,TradeItem ti)
    {
