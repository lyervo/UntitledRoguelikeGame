 ...
 * @author Timot
 */
public class BuyAllButton extends Button
{

    private TradeItem ti;

    public BuyAllButton(int x, int y, int width, int height, String text, Color border, Color fill, Color hoverFill, TrueTypeFont font,TradeItem ti)
    {
